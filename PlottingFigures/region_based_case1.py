...
plt.legend(prop=legend_font1,ncol = 4, loc="best",columnspacing = 0.4)
ax = plt.gca()
# ax.yaxis.set_major_locator(MultipleLocator(0.2))
plt.tight_layout()
# plt.show()

plt.savefig("/Users/zihanding/Desktop/research/CPS/Thesis/3.15 update figure/3.16update/evaluation_fig/region_evaluation_case1.pdf")
